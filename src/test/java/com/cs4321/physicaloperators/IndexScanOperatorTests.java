...
public class IndexScanOperatorTests {
  ...
  private static final String boatsEIndexFilePath = System.getProperty("user.dir") + sep + "src" + sep + "test" + sep
      + "resources" + sep + "expected_indexes" + sep + "Boats.E";
  private final DatabaseCatalog dbc = DatabaseCatalog.getInstance();
  private static AliasMap mockAliasMap;
  ...
  static void setup() {
    ...
    Mockito.when(mockAliasMap.getBaseTable(Mockito.any())).thenReturn("Boats");
  }

  @Test
  void getNextTupleUnclusteredIndexTest() throws FileNotFoundException, IOException {
    // lowKey equal to highKey
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 10, 10,
        false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 54, 54,
        false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 6, 10, false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 13, 15, false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 9, 13, false);
    assertEquals(new Tuple("4748,10,1432"), scanOperator.getNextTuple());
    assertEquals(new Tuple("3172,13,5062"), scanOperator.getNextTuple());
    assertNull(scanOperator.getNextTuple());

    // Scan Items on one leaf page with both low key and high key absent
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 9, 15, false);
    assertEquals(new Tuple("4748,10,1432"), scanOperator.getNextTuple());
    assertEquals(new Tuple("3172,13,5062"), scanOperator.getNextTuple());
    assertEquals(new Tuple("3169,14,1890"), scanOperator.getNextTuple());
    assertNull(scanOperator.getNextTuple());
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 152, 155, false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 208, 210, false);
    ...
    // present
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 9998, 20000,
        false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 36, 42,
        false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 4, 6,
        false);
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 1, 6,
        false);
    assertEquals(new Tuple("9206,4,5488"), scanOperator.getNextTuple());
    assertEquals(new Tuple("7775,4,6175"), scanOperator.getNextTuple());
    assertEquals(new Tuple("9076,4,8209"), scanOperator.getNextTuple());
    ...
    scanOperator = new IndexScanOperator(table, mockAliasMap, boatsEIndexFilePath, indexAttributeName, 1431, 1434,
        false);
