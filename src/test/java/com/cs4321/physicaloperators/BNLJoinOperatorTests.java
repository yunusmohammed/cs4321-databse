...
public class BNLJoinOperatorTests {
    ...
    void testGetNextTuple() {
        ...
        Mockito
                .when(
                        visitor.evalExpression(Mockito.any(), Mockito.any(),
                                AdditionalMatchers.not(Mockito.eq(new Tuple("6,7")))))
                .thenReturn(false);
        Mockito.when(visitor.evalExpression(Mockito.any(), Mockito.any(), Mockito.eq(new Tuple("6,7"))))
                .thenReturn(true);
        ...
        Mockito
                .when(
                        visitor.evalExpression(Mockito.any(), AdditionalMatchers.not(Mockito.eq(new Tuple("6,7,8"))),
                                Mockito.any()))
                .thenReturn(false);
        Mockito.when(visitor.evalExpression(Mockito.any(), Mockito.eq(new Tuple("6,7,8")), Mockito.any()))
                .thenReturn(true);
