...
class JoinOrderTest {
    ...
    void getJoinOrder() throws ParseException {
        try (MockedStatic<DatabaseCatalog> dbcMockedStatic = Mockito.mockStatic(DatabaseCatalog.class)) {
            ...
            TableStatsInfo sailorsInfo = new TableStatsInfo(Arrays.asList(sailorsA, sailorsB, sailorsC), "Sailors");
            ...
            List<LogicalOperator> joinChildren = Arrays.asList(sailorsSelection, reservesSelection, boatsScan);
            List<LogicalOperator> joinChildren2 = Arrays.asList(boatsScan, sailorsSelection, reservesSelection);
